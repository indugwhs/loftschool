...
public class BudgetViewModel extends ViewModel {
        ...
        compositeDisposable.add(moneyApi.getMoneyItems(typeRequest, authToken)
                ...
                .subscribe(moneyRemoteItems -> {
                    ...
                    for (MoneyRemoteItem moneyRemoteItem : moneyRemoteItems) {
                        moneyItemModels.add(new Item(moneyRemoteItem.getItemId(),
                                moneyRemoteItem.getName(),
                                String.valueOf(moneyRemoteItem.getPrice()),
                                currentPosition));
                    }
    ...
    public void removeItems(MoneyApi moneyApi, SharedPreferences sharedPreferences, List<Item> items) {
        String authToken = sharedPreferences.getString(LoftApp.AUTH_KEY, "");
